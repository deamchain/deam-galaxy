...
var (
	...
	AllowedGalaxyGenesisHashes = map[uint64]hash.Hash{
		galaxy.MainNetworkID: hash.HexToHash("0x02f59c4016f267a9f14ed1366a8457abc9b91d4b312cc3054d086177989901b1"),
		galaxy.TestNetworkID: hash.HexToHash("0x74644224c18ffe83b9334baee403ac59ce752ac9efe5fb44b717b2830398c230"),
	}
)
...
func getGalaxyGenesis(ctx *cli.Context) integration.InputGenesis {
	...
	case ctx.GlobalIsSet(FakeNetFlag.Name):
		...
		fakeGenesisStore := makegenesis.FakeGenesisStore(num, futils.ToUnit(1000000000), futils.ToUnit(5000000))
...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "eth", "deam", "dag", "sfc", "abft", "web3")
	cfg.WSModules = append(cfg.WSModules, "eth", "deam", "dag", "sfc", "abft", "web3")
